...
{
    public partial class Modelare : Form
    {
        public Modelare()
        {
            InitializeComponent();
        ...
        private void Modelare_Load(object sender, EventArgs e)
        {
            ...
            int i;
            label3.Text = serviciiTableAdapter.pret("Modelare teren").ToString();
            try
            {
                this.angajatiTableAdapter.ceva(this._proiect__1_DataSet.Angajati, 5).ToString();
