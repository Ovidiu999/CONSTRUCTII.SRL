...
{
    public partial class Șanț : Form
    {
        public Șanț()
        {
            InitializeComponent();
        ...
        private void Șanț_Load_1(object sender, EventArgs e)
        {
            ...
            int i;
            label3.Text = serviciiTableAdapter.pret("Sant").ToString();
            try
            {
                this.angajatiTableAdapter.ceva(this._proiect__1_DataSet.Angajati, 1).ToString();
