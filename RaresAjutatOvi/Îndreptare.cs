...
{
    public partial class Îndreptare : Form
    {
        public Îndreptare()
        {
            InitializeComponent();
        ...
        private void Îndreptare_Load(object sender, EventArgs e)
        {
            ...
            int i;
            label3.Text = serviciiTableAdapter.pret("Indreptare curte").ToString();
            try
            {
                this.angajatiTableAdapter.ceva(this._proiect__1_DataSet.Angajati, 4).ToString();
